...
r_f_name <- paste0("result/",element, "model_summary.txt")
...
>>>>>>> a3cc789968f1b4fbaf303584c048db505fbd3078
                #+ edgecov(X.list)
                + mutual
                + nodecov("indegree")
...
=======
h_f_name <- paste0("html/", element, "_network_movie.html")
...
<<<<<<< HEAD
label <- ifelse(deg>=3, network.vertex.names(net1), "")
=======
...
png(filename, width = 1200, height = 900, res = 150)
imgname <- paste0(element, " Network : 2020 ~")
...
png(filename, width = 1200, height = 900, res = 150)
imgname <- paste0(element, " Network : 2025 ~")
...
label <- ifelse(deg>=2, network.vertex.names(simp2), "")
set.seed(5156)

filename <- paste0("img/", element, "_network_plot_2030.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
imgname <- paste0(element, " Network : 2030 ~")
...
png(filename, width = 1200, height = 900, res = 150)
imgname <- paste0(element, " Network : 2035 ~")
