...
params: 
  element: "White Carbon (SiO2)"
  option : "ver1_"
---


```{r}
# 세라믹 회의 이후, 세라믹 기술원 요청사항에 따라 데이터 셋 변경하여 테스트 진행 
...
ele_f_t15 <- paste0(params$option, "data/", element, "_edge_list_data_2015.csv")
ele_f_t20 <- paste0(params$option, "data/", element, "_edge_list_data_2020.csv")
...
# === 8. 결과 확인 ===
r_f_name <- paste0(option, "result/",element, "model_summary.txt")
...
h_f_path <- paste0(option, "html/", element, "_simulation_movie.html") 
...
filename <- paste0(option, "img/", element, "_network_plot_2015.png")  # => "network_plot_2050.png"
...
filename <- paste0(option, "img/", element, "_network_plot_2020.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
...
filename <- paste0(option, "img/", element, "_network_plot_2025.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
...
filename <- paste0(option, "img/", element, "_network_plot_2030.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
...
# 1️⃣ 저장할 파일 열기
filename <- paste0(option, "img/", element, "_network_plot_2035.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
