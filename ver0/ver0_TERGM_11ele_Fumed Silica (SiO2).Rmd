...
model <- tergm(net.list ~ edges 
                + gwesp(0.01, fixed = TRUE) 
                #+ edgecov(X.list)
                + mutual
                + nodecov("indegree")
                + diff(attr="indegree", dir="t-h")
                , 
                estimate="CMPLE", times=0:2)
...
h_f_path <- paste0(params$option, "html/", element, "_simulation_movie.html") 
...
filename <- paste0(params$option, "img/", element, "_network_plot_2020.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
...
filename <- paste0(params$option, "img/", element, "_network_plot_2025.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
...
filename <- paste0(params$option, "img/", element, "_network_plot_2030.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
...
# 1️⃣ 저장할 파일 열기
filename <- paste0(params$option, "img/", element, "_network_plot_2035.png")  # => "network_plot_2050.png"
png(filename, width = 1200, height = 900, res = 150)
